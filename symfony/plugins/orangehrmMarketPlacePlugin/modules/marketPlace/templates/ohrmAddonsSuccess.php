...
<div class="modal hide" id="buyNowModal">
    ...
    <div class="modal-body">
        ...
        <p><?php echo __("Please confirm your contact details. Your details will be forwarded to sales@orangehrm.com.
        Our team members will contact you ti guide you through the acquiring process."); ?></p>
        <div class="box">
...
<script>
    ...
    var emailRequired = "<?php echo __('Email required'); ?>";
    var emailValidation = "<?php echo __('Enter a valid email'); ?>";
    var contactRequired = "<?php echo __('Contact number required'); ?>";
    var contactValidation = "<?php echo __('Enter a valid contact number'); ?>";
    var organizationRequired = "<?php echo __('Organization required'); ?>";
